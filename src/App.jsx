    ...
    <div style={{ position:"fixed", inset:0, background:"#000", zIndex:200, display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:1, display:"flex", overflow:"hidden", minHeight:0 }}>
        ...
        <div style={{ width:100, background:"#080808", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:8, padding:10, borderLeft:"1px solid #1a1a1a", flexShrink:0 }}>
          ...
          {previewUrl ? <img src={previewUrl} style={{ width:80, height:mode==="portrait"?80*(4/3):80, objectFit:"cover", borderRadius:2, border:"1px solid #222", maxHeight:120 }} /> : <div style={{ width:80, height:80, background:"#111", borderRadius:2 }} />}
          {crop.w > 10 && <div style={{ fontSize:8, color:"#444", textAlign:"center" }}>{Math.round(crop.w)}×{Math.round(crop.h)}</div>}
        </div>
      </div>
      <div style={{ padding:"8px 0", textAlign:"center", color:"#333", fontSize:9, letterSpacing:1.5, textTransform:"uppercase", flexShrink:0 }}>Drag · Handles to resize</div>
    </div>
  );
}
        ...
        <div style={{ padding:24, fontFamily:"'DM Sans', system-ui, sans-serif" }}>
          ...
          {receiptData && receiptData.length === 0 && (
            <div style={{ textAlign:"center", padding:"40px 0", color:"#666" }}>
              <div style={{ marginBottom:12 }}>No items found.</div>
