...
export default function WardrobeApp(){
  ...
  const [chatHistory,setChatHistory]=useState(()=>{try{return JSON.parse(localStorage.getItem("wardrobe-chat")||"[]")}catch{return[]}});
  ...
  return(<div style={{minHeight:"100vh",background:"#111",color:"#e8e2d8",fontFamily:"Georgia, 'Times New Roman', serif",maxWidth:900,margin:"0 auto"}}>
    ...
    {view==="chat"&&(<div style={{fontFamily:"'DM Sans', system-ui, sans-serif",paddingBottom:80}}>
      ...
      <div style={{position:"sticky",bottom:0,padding:"12px 16px",borderTop:"1px solid #1a1a1a",background:"#111",display:"flex",gap:8,zIndex:10,alignItems:"center"}}>
        {learnedIndicator&&<div style={{fontSize:9,color:"#b8976a",letterSpacing:1.5,textTransform:"uppercase",flexShrink:0}}>✦ learned</div>}
