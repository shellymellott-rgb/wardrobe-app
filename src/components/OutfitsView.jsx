  ...
  return (
    <div style={{padding:"24px 24px 100px",fontFamily:"'DM Sans', system-ui, sans-serif"}}>
      ...
      {(savedOutfits && savedOutfits.length > 0) ? (
          ...
          {savedOutfits.map(outfit => {
            ...
            return (
              <div key={outfit.id} style={{background:"#111",border:"1px solid #1e1e1e",borderRadius:8,marginBottom:14,overflow:"hidden"}}>
                ...
                {outfitItems.length === 0 && (
                  <div style={{padding:"0 16px 14px",fontSize:11,color:"#444"}}>No matching items in closet</div>
                )}
              </div>
            );
          })}
        ...
        <div style={{marginTop:28,textAlign:"center",color:"#333",fontSize:11,letterSpacing:1.5,textTransform:"uppercase",padding:"20px 0"}}>
